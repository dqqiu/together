...
CREATE SCHEMA IF NOT EXISTS security DEFAULT CHARACTER SET utf8mb4 collate utf8mb4_unicode_ci;
...
grant  SELECT, INSERT, UPDATE, DELETE, CREATE, DROP, REFERENCES, INDEX, ALTER, LOCK TABLES, EXECUTE on security.* to together@"%" Identified by "together123456";
